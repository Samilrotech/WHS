            ...
            <div class="form-check custom-option custom-option-basic">
              <label class="form-check-label custom-option-content" for="customRadioTemp1" data-bs-target="#twoFactorAuthOne" data-bs-toggle="modal">
                ...
                <span class="custom-option-header">
                  <span class="h6 mb-0 d-flex align-items-center"><i class="icon-base ti ti-settings me-1"></i>Authenticator Apps</span>
                </span>
          ...
          <div class="col-12">
            <div class="form-check custom-option custom-option-basic">
              <label class="form-check-label custom-option-content" for="customRadioTemp2" data-bs-target="#twoFactorAuthTwo" data-bs-toggle="modal">
                ...
                <span class="custom-option-header">
                  <span class="h6 mb-0 d-flex align-items-center"><i class="icon-base ti ti-message me-1"></i>SMS</span>
                </span>
                <span class="custom-option-body">
    ...
    <div class="modal-content">
      <div class="modal-body">
        ...
        <div class="text-end">
          ...
          <button type="button" class="btn btn-success" data-bs-dismiss="modal" aria-label="Close"><span class="align-middle">Submit</span><i class="icon-base ti ti-check icon-xs ms-2"></i></button>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="modal-dialog modal-lg modal-dialog-centered modal-simple">
    <div class="modal-content">
      <div class="modal-body">
        ...
        <div class="text-end">
          <button type="button" class="btn btn-label-secondary me-3" data-bs-toggle="modal" data-bs-target="#twoFactorAuth"><span class="align-middle">Cancel</span></button>
          <button type="button" class="btn btn-success" data-bs-dismiss="modal" aria-label="Close"><span class="align-middle">Submit</span><i class="icon-base ti ti-check ms-2"></i></button>
        </div>
      </div>
    </div>
  </div>
