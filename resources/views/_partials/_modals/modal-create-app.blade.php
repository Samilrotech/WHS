          ...
          <div class="bs-stepper-header border-0 p-1">
            <div class="step" data-target="#details">
              <button type="button" class="step-trigger">
                <span class="bs-stepper-circle"><i class="icon-base ti ti-file-text icon-md"></i></span>
            ...
            <div class="step" data-target="#frameworks">
              <button type="button" class="step-trigger">
                <span class="bs-stepper-circle"><i class="icon-base ti ti-box icon-md"></i></span>
                <span class="bs-stepper-label">
            ...
            <div class="step" data-target="#database">
              <button type="button" class="step-trigger">
                <span class="bs-stepper-circle"><i class="icon-base ti ti-database icon-md"></i></span>
                <span class="bs-stepper-label">
            ...
            <div class="step" data-target="#billing">
              <button type="button" class="step-trigger">
                <span class="bs-stepper-circle"><i class="icon-base ti ti-credit-card icon-md"></i></span>
                <span class="bs-stepper-label">
            ...
            <div class="step" data-target="#submit">
              <button type="button" class="step-trigger">
                <span class="bs-stepper-circle"><i class="icon-base ti ti-check icon-md"></i></span>
                <span class="bs-stepper-label">
          ...
          <div class="bs-stepper-content p-1">
            <form onSubmit="return false">
              ...
              <div id="details" class="content pt-4 pt-lg-0">
                ...
                <ul class="p-0 m-0">
                  <li class="d-flex align-items-start mb-4">
                    <div class="badge bg-label-info p-2 me-3 rounded"><i class="icon-base ti ti-file-text icon-30px"></i></div>
                  ...
                  <li class="d-flex align-items-start mb-4">
                    <div class="badge bg-label-success p-2 me-3 rounded"><i class="icon-base ti ti-shopping-cart icon-30px"></i></div>
                    <div class="d-flex justify-content-between w-100 flex-wrap gap-2">
                      <div class="me-2">
                  ...
                  <li class="d-flex align-items-start">
                    <div class="badge bg-label-danger p-2 me-3 rounded"><i class="icon-base ti ti-device-laptop icon-30px"></i></div>
                    <div class="d-flex justify-content-between w-100 flex-wrap gap-2">
                      <div class="me-2">
                ...
                <div class="col-12 d-flex justify-content-between mt-6">
                  ...
                  <button class="btn btn-primary btn-next"><span class="align-middle d-sm-inline-block d-none me-sm-2">Next</span> <i class="icon-base ti ti-arrow-right icon-xs"></i></button>
                </div>
              </div>
              ...
              <div id="frameworks" class="content pt-4 pt-lg-0">
                ...
                <ul class="p-0 m-0">
                  <li class="d-flex align-items-start mb-4">
                    <div class="badge bg-label-info p-2 me-3 rounded"><i class="icon-base ti ti-brand-react-native icon-30px"></i></div>
                  ...
                  <li class="d-flex align-items-start mb-4">
                    <div class="badge bg-label-danger p-2 me-3 rounded"><i class="icon-base ti ti-brand-angular icon-30px"></i></div>
                    <div class="d-flex justify-content-between w-100 flex-wrap gap-2">
                      <div class="me-2">
                  ...
                  <li class="d-flex align-items-start mb-4">
                    <div class="badge bg-label-warning p-2 me-3 rounded"><i class="icon-base ti ti-brand-html5 icon-30px"></i></div>
                    <div class="d-flex justify-content-between w-100 flex-wrap gap-2">
                      <div class="me-2">
                  ...
                  <li class="d-flex align-items-start">
                    <div class="badge bg-label-success p-2 me-3 rounded"><i class="icon-base ti ti-brand-vue icon-30px"></i></div>
                    <div class="d-flex justify-content-between w-100 flex-wrap gap-2">
                      <div class="me-2">
                ...
                <div class="col-12 d-flex justify-content-between mt-6">
                  <button class="btn btn-label-secondary btn-prev"><i class="icon-base ti ti-arrow-left icon-xs me-sm-2 me-0"></i> <span class="align-middle d-sm-inline-block d-none">Previous</span></button>
                  <button class="btn btn-primary btn-next"><span class="align-middle d-sm-inline-block d-none me-sm-2">Next</span> <i class="icon-base ti ti-arrow-right icon-xs"></i></button>
                </div>
              </div>
              ...
              <div id="database" class="content pt-4 pt-lg-0">
                ...
                <ul class="p-0 m-0">
                  <li class="d-flex align-items-start mb-4">
                    <div class="badge bg-label-danger p-2 me-3 rounded"><i class="icon-base ti ti-brand-firebase icon-30px"></i></div>
                    <div class="d-flex justify-content-between w-100 flex-wrap gap-2">
                      <div class="me-2">
                  ...
                  <li class="d-flex align-items-start mb-4">
                    <div class="badge bg-label-warning p-2 me-3 rounded"><i class="icon-base ti ti-brand-amazon icon-30px"></i></div>
                    <div class="d-flex justify-content-between w-100 flex-wrap gap-2">
                      <div class="me-2">
                  ...
                  <li class="d-flex align-items-start">
                    <div class="badge bg-label-info p-2 me-3 rounded"><i class="icon-base ti ti-database icon-30px"></i></div>
                    <div class="d-flex justify-content-between w-100 flex-wrap gap-2">
                      <div class="me-2">
                ...
                <div id="AppNewCCForm" class="row g-6 pt-3 pt-lg-0 mb-6" onsubmit="return false">
                  ...
                  <div class="col-6 col-md-3">
                    ...
                    <div class="input-group input-group-merge">
                      ...
                      <span class="input-group-text cursor-pointer ps-0" id="modalAppAddCardCvv2"><i class="text-body-secondary icon-base ti ti-help" data-bs-toggle="tooltip" data-bs-placement="top" title="Card Verification Value"></i></span>
                    </div>
                  </div>
                  <div class="col-12">
