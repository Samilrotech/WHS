        ...
        <form class="row g-4" onsubmit="return false">
          ...
          <div class="col-lg-3 d-flex align-items-end">
            <div class="btn-social d-flex justify-content-between w-100">
              <button type="button" class="btn btn-icon btn-facebook"><i class="icon-base ti ti-brand-facebook icon-22px"></i></button>
              <button type="button" class="btn btn-icon btn-twitter"><i class="icon-base ti ti-brand-twitter icon-22px"></i></button>
              <button type="button" class="btn btn-icon btn-linkedin"><i class="icon-base ti ti-brand-linkedin icon-22px"></i></button>
            </div>
          </div>
        </form>
      </div>
