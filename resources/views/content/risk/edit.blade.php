  ...
  <div class="col-12">
    <div class="card mb-4">
      <div class="card-header d-flex justify-content-between align-items-center">
        <h5 class="mb-0">Edit Risk Assessment</h5>
        <div class="d-flex gap-2">
          <a href="{{ route('risk.show', $assessment) }}" class="btn btn-sm btn-info">
      ...
      <div class="card-body">
        <form action="{{ route('risk.update', $assessment) }}" method="POST" class="needs-validation" novalidate>
          @csrf
          @method('PUT')
          ...
          <div class="mb-3">
            ...
            <select id="category"
              ...
              @foreach($categories as $key => $label)
                <option value="{{ $key }}" {{ old('category', $assessment->category) == $key ? 'selected' : '' }}>{{ $label }}</option>
              @endforeach
            </select>
            @error('category')
          ...
          <div class="mb-3">
            ...
            <input type="text"
                   ...
                   value="{{ old('task_description', $assessment->task_description) }}"
                   maxlength="500"
                   required>
          ...
          <div class="row">
            <div class="col-md-6 mb-3">
              ...
              <input type="text"
                     ...
                     value="{{ old('location', $assessment->location) }}"
                     maxlength="255"
                     required>
              @error('location')
                <div class="invalid-feedback d-block">{{ $message }}</div>
            ...
            <div class="col-md-6 mb-3">
              ...
              <input type="date"
                     ...
                     value="{{ old('assessment_date', $assessment->assessment_date ? \Carbon\Carbon::parse($assessment->assessment_date)->format('Y-m-d') : date('Y-m-d')) }}"
                     required>
          ...
          <div class="row">
            ...
            <div class="col-md-4 mb-3">
              ...
              <select id="initial_likelihood"
                ...
                <option value="1" {{ old('initial_likelihood', $assessment->initial_likelihood) == '1' ? 'selected' : '' }}>1 - Rare</option>
                <option value="2" {{ old('initial_likelihood', $assessment->initial_likelihood) == '2' ? 'selected' : '' }}>2 - Unlikely</option>
                <option value="3" {{ old('initial_likelihood', $assessment->initial_likelihood) == '3' ? 'selected' : '' }}>3 - Possible</option>
                <option value="4" {{ old('initial_likelihood', $assessment->initial_likelihood) == '4' ? 'selected' : '' }}>4 - Likely</option>
                <option value="5" {{ old('initial_likelihood', $assessment->initial_likelihood) == '5' ? 'selected' : '' }}>5 - Almost Certain</option>
              </select>
            ...
            <div class="col-md-4 mb-3">
              ...
              <select id="initial_consequence"
                      ...
                      required>
                <option value="">Select</option>
                <option value="1" {{ old('initial_consequence', $assessment->initial_consequence) == '1' ? 'selected' : '' }}>1 - Insignificant</option>
                <option value="2" {{ old('initial_consequence', $assessment->initial_consequence) == '2' ? 'selected' : '' }}>2 - Minor</option>
                <option value="3" {{ old('initial_consequence', $assessment->initial_consequence) == '3' ? 'selected' : '' }}>3 - Moderate</option>
                <option value="4" {{ old('initial_consequence', $assessment->initial_consequence) == '4' ? 'selected' : '' }}>4 - Major</option>
                <option value="5" {{ old('initial_consequence', $assessment->initial_consequence) == '5' ? 'selected' : '' }}>5 - Catastrophic</option>
              </select>
          ...
          <div class="row">
            ...
            <div class="col-md-4 mb-3">
              ...
              <select id="residual_likelihood"
                      ...
                      required>
                <option value="">Select</option>
                <option value="1" {{ old('residual_likelihood', $assessment->residual_likelihood) == '1' ? 'selected' : '' }}>1 - Rare</option>
                <option value="2" {{ old('residual_likelihood', $assessment->residual_likelihood) == '2' ? 'selected' : '' }}>2 - Unlikely</option>
                <option value="3" {{ old('residual_likelihood', $assessment->residual_likelihood) == '3' ? 'selected' : '' }}>3 - Possible</option>
                <option value="4" {{ old('residual_likelihood', $assessment->residual_likelihood) == '4' ? 'selected' : '' }}>4 - Likely</option>
                <option value="5" {{ old('residual_likelihood', $assessment->residual_likelihood) == '5' ? 'selected' : '' }}>5 - Almost Certain</option>
              </select>
            ...
            <div class="col-md-4 mb-3">
              ...
              <select id="residual_consequence"
                      ...
                      required>
                <option value="">Select</option>
                <option value="1" {{ old('residual_consequence', $assessment->residual_consequence) == '1' ? 'selected' : '' }}>1 - Insignificant</option>
                <option value="2" {{ old('residual_consequence', $assessment->residual_consequence) == '2' ? 'selected' : '' }}>2 - Minor</option>
                <option value="3" {{ old('residual_consequence', $assessment->residual_consequence) == '3' ? 'selected' : '' }}>3 - Moderate</option>
                <option value="4" {{ old('residual_consequence', $assessment->residual_consequence) == '4' ? 'selected' : '' }}>4 - Major</option>
                <option value="5" {{ old('residual_consequence', $assessment->residual_consequence) == '5' ? 'selected' : '' }}>5 - Catastrophic</option>
              </select>
          ...
          <div class="mb-3">
            ...
            <input type="date"
                   ...
                   value="{{ old('review_date', $assessment->review_date ? \Carbon\Carbon::parse($assessment->review_date)->format('Y-m-d') : '') }}">
            @error('review_date')
              <div class="invalid-feedback d-block">{{ $message }}</div>
            @enderror
          ...
          <div class="d-flex justify-content-end gap-2">
            ...
            <button type="submit" class="btn btn-primary">
              <i class='bx bx-check me-1'></i> Update Risk Assessment
            </button>
          </div>
        </form>
      </div>
