  ...
  <div class="col-md-12">
    <div class="nav-align-top">
      <ul class="nav nav-pills flex-column flex-md-row mb-6 gap-md-0 gap-2">
        <li class="nav-item">
          <a class="nav-link active" href="javascript:void(0);"><i class="icon-base ti ti-users icon-sm me-1_5"></i> Account</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="{{ url('pages/account-settings-security') }}"><i class="icon-base ti ti-lock icon-sm me-1_5"></i> Security</a>
        </li>
        <li class="nav-item">
        ...
        <div class="d-flex align-items-start align-items-sm-center gap-6">
          ...
          <div class="button-wrapper">
            ...
            <button type="button" class="btn btn-label-secondary account-image-reset mb-4">
              <i class="icon-base ti ti-reset d-block d-sm-none"></i>
