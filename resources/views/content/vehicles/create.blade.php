        ...
        <form action="{{ route('vehicles.store') }}" method="POST" class="needs-validation" novalidate>
              ...
              <div class="mb-3">
                ...
                <select id="depreciation_method" name="depreciation_method" class="form-select @error('depreciation_method') is-invalid @enderror">
                  @foreach($depreciationMethods as $value => $label)
                    <option value="{{ $value }}" {{ old('depreciation_method', 'straight_line') === $value ? 'selected' : '' }}>{{ $label }}</option>
                  @endforeach
                </select>
            ...
            <div class="col-md-12">
              <div class="mb-3">
                ...
                <input
                  ...
                  value="{{ old('depreciation_rate', 20) }}"
                  step="0.01"
                  min="0"
                  max="100">
          ...
          <div class="d-flex gap-2">
            <button type="submit" class="btn btn-primary">
              <i class='icon-base ti ti-device-floppy me-1'></i> Create Vehicle
            </button>
