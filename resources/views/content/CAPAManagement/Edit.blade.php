  ...
  <div class="col-12">
    <div class="card mb-4">
      <div class="card-header d-flex justify-content-between align-items-center">
        <h5 class="mb-0">Edit CAPA: {{ $capa->capa_number }}</h5>
        <div class="d-flex gap-2">
          <a href="{{ route('capa.show', $capa) }}" class="btn btn-sm btn-outline-secondary">
            <i class="bx bx-show me-1"></i> View CAPA
          </a>
      ...
      <div class="card-body">
        ...
        <div class="alert alert-warning mb-4">
          ...
          <strong>Note:</strong> This CAPA has been submitted (Status: {{ ucfirst($capa->status) }}). Some fields may be restricted for editing.
        </div>
        @endif

        <form action="{{ route('capa.update', $capa) }}" method="POST" id="capaForm">
          @csrf
          @method('PUT')
          ...
          <div class="row">
            ...
            <div class="col-md-6 mb-3">
              ...
              <select id="type" name="type" class="form-select @error('type') is-invalid @enderror" required>
                ...
                <option value="corrective" {{ old('type', $capa->type) === 'corrective' ? 'selected' : '' }}>Corrective Action</option>
                <option value="preventive" {{ old('type', $capa->type) === 'preventive' ? 'selected' : '' }}>Preventive Action</option>
              </select>
              @error('type')
            ...
            <div class="col-12 mb-3">
              ...
              <textarea id="description" name="description" rows="4"
                        ...
                        required>{{ old('description', $capa->description) }}</textarea>
              @error('description')
                <div class="invalid-feedback">{{ $message }}</div>
              @enderror
            </div>
            ...
            <div class="col-md-6 mb-3">
              ...
              <select id="assigned_to_user_id" name="assigned_to_user_id" class="form-select select2 @error('assigned_to_user_id') is-invalid @enderror">
                ...
                @foreach(\App\Models\User::where('branch_id', auth()->user()->branch_id)->orderBy('name')->get() as $user)
                  <option value="{{ $user->id }}" {{ old('assigned_to_user_id', $capa->assigned_to_user_id) == $user->id ? 'selected' : '' }}>
                    {{ $user->name }}
                  </option>
                @endforeach
              </select>
            ...
            <div class="col-md-6 mb-3">
              ...
              <select id="incident_id" name="incident_id" class="form-select select2 @error('incident_id') is-invalid @enderror">
                ...
                @foreach(\App\Modules\IncidentManagement\Models\Incident::where('branch_id', auth()->user()->branch_id)->latest()->take(50)->get() as $incident)
                  <option value="{{ $incident->id }}" {{ old('incident_id', $capa->incident_id) == $incident->id ? 'selected' : '' }}>
          ...
          <div class="row">
            ...
            <div class="col-12 mb-3">
              ...
              <textarea id="problem_statement" name="problem_statement" rows="3"
                        ...
                        placeholder="Clear statement of the problem to be addressed">{{ old('problem_statement', $capa->problem_statement) }}</textarea>
            ...
            <div class="col-12 mb-3">
              ...
              <textarea id="root_cause_analysis" name="root_cause_analysis" rows="4"
                        ...
                        placeholder="Detailed analysis of the root cause(s)">{{ old('root_cause_analysis', $capa->root_cause_analysis) }}</textarea>
            ...
            <div class="col-12 mb-3">
              ...
              <textarea id="five_whys" name="five_whys" rows="5"
                        ...
                        placeholder="Why 1: [Answer]&#10;Why 2: [Answer]&#10;Why 3: [Answer]&#10;Why 4: [Answer]&#10;Why 5: [Root Cause]">{{ old('five_whys', $capa->five_whys) }}</textarea>
              @error('five_whys')
                <div class="invalid-feedback">{{ $message }}</div>
              @enderror
            ...
            <div class="col-12 mb-3">
              ...
              <textarea id="contributing_factors" name="contributing_factors" rows="3"
                        ...
                        placeholder="Additional factors that contributed to the problem">{{ old('contributing_factors', $capa->contributing_factors) }}</textarea>
          ...
          <div class="row">
            ...
            <div class="col-12 mb-3">
              ...
              <textarea id="proposed_action" name="proposed_action" rows="4"
                        ...
                        required>{{ old('proposed_action', $capa->proposed_action) }}</textarea>
            ...
            <div class="col-12 mb-3">
              ...
              <textarea id="resources_required" name="resources_required" rows="3"
                        ...
                        placeholder="Personnel, equipment, budget, etc.">{{ old('resources_required', $capa->resources_required) }}</textarea>
            ...
            <div class="col-md-4 mb-3">
              ...
              <div class="input-group">
                ...
                <input type="number" id="estimated_cost" name="estimated_cost"
                       ...
                       value="{{ old('estimated_cost', $capa->estimated_cost) }}"
                       min="0"
                       step="0.01"
                       placeholder="0.00">
            ...
            <div class="col-md-4 mb-3">
              ...
              <input type="number" id="estimated_hours" name="estimated_hours"
                     ...
                     value="{{ old('estimated_hours', $capa->estimated_hours) }}"
                     min="0"
          ...
          <div class="row">
            ...
            <div class="col-12 mb-3">
              ...
              <textarea id="notes" name="notes" rows="3"
                        ...
                        placeholder="Any additional notes or comments">{{ old('notes', $capa->notes) }}</textarea>
              @error('notes')
                <div class="invalid-feedback">{{ $message }}</div>
              @enderror
            </div>
          ...
          <div class="row mt-4">
            <div class="col-12">
              <button type="submit" class="btn btn-primary me-2">
                <i class="bx bx-save me-1"></i> Update CAPA
              </button>
              <a href="{{ route('capa.show', $capa) }}" class="btn btn-outline-secondary">
