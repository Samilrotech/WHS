...
<div class="row g-6">
  ...
  <div class="col-xxl-2 col-md-3 col-6">
    <div class="card h-100">
      <div class="card-body">
        <div class="badge p-2 bg-label-danger mb-3 rounded"><i class="icon-base ti ti-credit-card icon-28px"></i>
        </div>
  ...
  <div class="col-xxl-2 col-md-3 col-6">
    <div class="card h-100">
      <div class="card-body">
        <div class="badge p-2 bg-label-success mb-3 rounded"><i class="icon-base ti ti-credit-card icon-28px"></i>
        </div>
      ...
      <div class="card-header d-flex justify-content-between">
        ...
        <div class="dropdown">
          <button class="btn btn-text-secondary rounded-pill text-body-secondary border-0 p-2 me-n1" type="button"
            ...
            <i class="icon-base ti ti-dots-vertical icon-md text-body-secondary"></i>
          </button>
        ...
        <ul class="nav nav-tabs widget-nav-tabs pb-8 gap-4 mx-1 d-flex flex-nowrap" role="tablist">
          <li class="nav-item">
            <a href="javascript:void(0);"
              ...
              <div class="badge bg-label-secondary rounded p-2"><i
                  class="icon-base ti ti-shopping-cart icon-md"></i></div>
          ...
          <li class="nav-item">
            <a href="javascript:void(0);"
              ...
              <div class="badge bg-label-secondary rounded p-2"><i
                  class="icon-base ti ti-chart-bar-popular icon-md"></i></div>
          ...
          <li class="nav-item">
            <a href="javascript:void(0);"
              ...
              aria-selected="false">
              <div class="badge bg-label-secondary rounded p-2"><i
                  class="icon-base ti ti-currency-dollar icon-md"></i></div>
          ...
          <li class="nav-item">
            <a href="javascript:void(0);"
              ...
              aria-selected="false">
              <div class="badge bg-label-secondary rounded p-2"><i class="icon-base ti ti-chart-pie-2 icon-md"></i>
              </div>
          ...
          <li class="nav-item">
            <a href="javascript:void(0);" class="nav-link btn d-flex align-items-center justify-content-center disabled"
              ...
              <div class="badge bg-label-secondary rounded p-2"><i class="icon-base ti ti-plus icon-md"></i></div>
            </a>
          </li>
        </ul>
      ...
      <div class="card-header d-flex justify-content-between">
        ...
        <div class="dropdown">
          <button class="btn btn-text-secondary btn-icon rounded-pill text-body-secondary border-0 me-n1" type="button"
            ...
            <i class="icon-base ti ti-dots-vertical icon-22px text-body-secondary"></i>
          </button>
            ...
            <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
              ...
              <div class="user-progress">
                <p class="text-success fw-medium mb-0 d-flex align-items-center gap-1">
                  <i class="icon-base ti ti-chevron-up"></i>
                  25.8%
                </p>
              </div>
            </div>
            ...
            <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
              ...
              <div class="user-progress">
                <p class="text-danger fw-medium mb-0 d-flex align-items-center gap-1">
                  <i class="icon-base ti ti-chevron-down"></i>
                  6.2%
                </p>
              </div>
            </div>
      ...
      <div class="card-body">
        <div class="d-flex align-items-start">
          <div class="badge rounded bg-label-warning p-2 me-3 rounded"><i
              class="icon-base ti ti-currency-dollar icon-lg"></i></div>
    ...
    <div class="card h-100">
      <div class="card-header d-flex justify-content-between">
        <h5 class="card-title m-0 me-2 pt-1 mb-2 d-flex align-items-center"><i
            class="icon-base ti ti-list-details me-3"></i> Activity Timeline</h5>
        <div class="dropdown">
          <button class="btn btn-text-secondary rounded-pill text-body-secondary border-0 p-2 me-n1" type="button"
