    ...
    <div class="navbar navbar-expand-lg landing-navbar px-3 px-md-8">
      ...
      <div class="navbar-brand app-brand demo d-flex py-0 me-4 me-xl-8 ms-0">
        ...
        <button class="navbar-toggler border-0 px-0 me-4" type="button" data-bs-toggle="collapse"
          ...
          <i class="icon-base ti ti-menu-2 icon-lg align-middle text-heading fw-medium"></i>
        </button>
        <!-- Mobile menu toggle: End-->
        <a href="{{ url('front-pages/landing') }}" class="app-brand-link d-flex flex-column align-items-start">
          <img src="{{ asset('assets/img/branding/RR_RedWhite.png') }}" alt="Rotech Logo" height="36" class="mb-2">
          <span class="text-heading fw-semibold" style="font-size: 0.75rem; letter-spacing: 0.8px;">ROTECH WHS</span>
        </a>
      </div>
              ...
              <div class="row gy-4">
                  ...
                  <div class="h6 d-flex align-items-center mb-3 mb-lg-5">
                    <div class="avatar flex-shrink-0 me-3">
                      <span class="avatar-initial rounded bg-label-primary"><i
                          class="icon-base ti ti-layout-grid icon-lg"></i></span>
                    </div>
                  ...
                  <ul class="nav flex-column">
                    <li class="nav-item {{ $currentRouteName === 'front-pages-pricing' ? 'active' : '' }}">
                      <a class="nav-link mega-dropdown-link" href="{{ url('front-pages/pricing') }}">
                        <i class="icon-base ti ti-circle me-1 icon-12px"></i>
                        <span>Pricing</span>
                      </a>
                    </li>
                ...
                <div class="col-12 col-lg">
                  <div class="h6 d-flex align-items-center mb-3 mb-lg-5">
                    <div class="avatar flex-shrink-0 me-3">
                      <span class="avatar-initial rounded bg-label-primary"><i
                          class="icon-base ti ti-lock-open icon-lg"></i></span>
                    </div>
                ...
                <div class="col-12 col-lg">
                  <div class="h6 d-flex align-items-center mb-3 mb-lg-5">
                    <div class="avatar flex-shrink-0 me-3">
                      <span class="avatar-initial rounded bg-label-primary"><i
                          class="icon-base ti ti-file-analytics icon-lg"></i></span>
                    </div>
                    <span class="ps-1">Other</span>
                  </div>
                  <ul class="nav flex-column">
      ...
      <ul class="navbar-nav flex-row align-items-center ms-auto">
        ...
        <li class="nav-item dropdown-style-switcher dropdown me-2 me-xl-1">
          ...
          <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="nav-theme-text">
            <li>
              <button type="button" class="dropdown-item align-items-center {{ $configData['themeOptVal'] === 'light' ? 'active' : '' }}" data-bs-theme-value="light"
                aria-pressed="{{ $configData['themeOptVal'] === 'light' ? 'true' : 'false' }}">
                <span><i class="icon-base ti ti-sun icon-md me-3" data-icon="sun"></i>Light</span>
              </button>
            </li>
            <li>
              <button type="button" class="dropdown-item align-items-center {{ $configData['themeOptVal'] === 'dark' ? 'active' : '' }}" data-bs-theme-value="dark"
                aria-pressed="{{ $configData['themeOptVal'] === 'dark' ? 'true' : 'false' }}">
                <span><i class="icon-base ti ti-moon-stars icon-md me-3" data-icon="moon-stars"></i>Dark</span>
              </button>
            </li>
            <li>
              <button type="button" class="dropdown-item align-items-center {{ $configData['themeOptVal'] === 'system' ? 'active' : '' }}" data-bs-theme-value="system"
                aria-pressed="{{ $configData['themeOptVal'] === 'system' ? 'true' : 'false' }}">
                <span><i class="icon-base ti ti-device-desktop-analytics icon-md me-3"
        ...
        <li>
          <a href="{{ url('/auth/login-cover') }}" class="btn btn-primary" target="_blank"><span
              class="icon-base ti ti-login scaleX-n1-rtl me-md-1"></span><span
