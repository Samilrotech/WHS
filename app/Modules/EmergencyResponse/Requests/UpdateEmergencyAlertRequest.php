...
class UpdateEmergencyAlertRequest extends FormRequest
{
    ...
    {
        return [
            'type' => ['sometimes', 'required', 'in:panic,medical,fire,evacuation,other'],
            'status' => ['sometimes', 'required', 'in:triggered,responded,resolved,cancelled'],
    ...
    public function messages(): array
    {
        return [
            ...
            'response_notes.max' => 'Response notes cannot exceed 2000 characters.',
        ];
    }
}
