...
class UpdateRiskAssessmentRequest extends FormRequest
{
    ...
    {
        return [
            'category' => 'sometimes|required|in:warehouse,pos-installation,on-road,office,contractor',
            ...
            'initial_likelihood' => 'sometimes|required|integer|between:1,5',
            'initial_consequence' => 'sometimes|required|integer|between:1,5',

            // Residual risk (after controls)
            'residual_likelihood' => 'sometimes|required|integer|between:1,5',
            'residual_consequence' => 'sometimes|required|integer|between:1,5',
