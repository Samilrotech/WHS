...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Here you may define the feature flags that are available to your
    | application. Feature flags can be resolved using the Feature facade.
    |
    */

    'features' => [
        'dense-table' => \App\Features\DenseTableFeature::class,
    ],
];
